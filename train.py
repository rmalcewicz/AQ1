...
sys.path.insert(0, '/scratch/project_465003017/aq1_decoder')
...
_parser.add_argument('--data', default='/scratch/project_465003017/aq1_decoder/data/d3_zbasis_test.h5')
...
SAVE_DIR    = '/scratch/project_465003017/aq1_decoder/checkpoints'
LOG_PATH    = '/scratch/project_465003017/aq1_decoder/logs/train_log.txt'
