...
METRICS_PATH = os.environ.get("METRICS_PATH", "data/emerald_metrics.json")
...
if __name__ == "__main__":
    ...
    with h5py.File(f"{OUTPUT_DIR}/d3_zbasis_emerald_full.h5", "w") as f:
    ...
    print(f"\nDone. Saved to {OUTPUT_DIR}/d3_zbasis_emerald_full.h5")
